...
function showProductDetails(productId) {
  ...
  if (product) {
    ...
    document.querySelector(".modal-body .modal-description").textContent =
      product.description;
    document.querySelector(".modal-body .modal-rating").textContent =
      product.rating.rate;
    document.querySelector(".modal-body .modal-rating-count").textContent =
      product.rating.count;
    document.querySelector(
      ".modal-body .modal-price"
    ).textContent = `$${product.price}`;
    document.querySelector(".modal-body .modal-category").textContent =
      product.category;
