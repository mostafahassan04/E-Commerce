  ...
  productsList.forEach((product) => {
    cartona += `
            <div class="col-md-4 mb-4">
                <div class="card" onclick="showProductDetails(${product.id})" title="click to view details">
                    ...
                    <div class="card-body">
                        ...
                        <button class="btn btn-primary addToCartButton" onclick="addToCart(${product.id})" title="">Add to Cart</button>
